// https://wordpress.ideacompo.com/?p=15636
id3 = (function () {
    ...
    // ----------
    // id3v1
    id3.prototype.v1 = function (binary) {
    ...
    id3.prototype.v1_str = function (data) {
    ...
    // ----------
    // id3v2
    id3.prototype.v2 = function (binary, buffer) {
        if (!binary) { return null; }
    ...
    id3.prototype.v2_header = function (datas) {
        return {
    ...
    id3.prototype.v2_header_size = function (datas) {
        var num = 0;
        num += datas[0] << 0x15;
        num += datas[1] << 14;
        num += datas[2] << 7;
    ...
    // ----------
    // v2.2
    id3.prototype.v22_frames = function (datas, offset) {
        var res = {};
    ...
    id3.prototype.v22_frame = function (datas) {
        var lib = new LIB();
    ...
    // ----------
    // v2.3
    id3.prototype.v23_frames = function (datas, offset) {
        var res = {};
        while (datas.length > offset) {
    ...
    id3.prototype.v23_frame = function (datas) {
        var lib = new LIB();
